...
ckpt = torch.load(os.path.join(args.checkpoint_path, "checkpoint_step_500000_final.pt"), map_location=device, weights_only=False)
cfg_loaded = None
...
losses = ckpt['losses']
model.eval()
print(f"Loaded model from {os.path.join(args.checkpoint_path, 'checkpoint_step_500000_final.pt')}")
