...
# Null Cluster Baseline — Stage 3 vertex sample collection (768 clusters)
#
# Loads pre-trained null cluster AANet models from Stage 1 and collects
# near-vertex examples for selected clusters.
#
# Run from project root: ./run_scripts/run_null_refit_768.sh
#
...
python -u real_data_tests/refit_selected_clusters.py \
    ...
    --manual_cluster_ids "768:FILL_IN" \
    --manual_k "768:FILL_IN"

echo ""
echo "============================================================"
echo "Stage 3 complete for null 768 clusters"
echo "============================================================"
