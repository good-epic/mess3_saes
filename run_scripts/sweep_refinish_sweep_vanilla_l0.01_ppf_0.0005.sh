...
# Auto-generated on 2025-10-16T22:20:11.149791Z to resume sweep_vanilla_l0.01_ppf_0.0005.sh
...
echo "Resuming sweep: Vanilla lambda=$SAE_VALUE, per-point filtering=$PER_POINT_THRESHOLD"
