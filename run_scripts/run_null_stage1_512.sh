...
# Null Cluster Baseline — Stage 1 (512 clusters)
#
# Generates a random partition of SAE latents matching the real 512-cluster
# size distribution, then runs the full AANet training + elbow analysis
# pipeline on those null clusters.
#
# Run from project root: ./run_scripts/run_null_stage1_512.sh
#
# After this completes:
#   1. Download outputs/null_clusters/clusters_512/consolidated_metrics_n512.csv
#   2. Review elbow plots: PYTHONPATH=. python scripts/plot_elbow_browser.py
#        --csv_dir outputs/null_clusters --n_clusters 512
#   3. Select clusters and fill in run_null_refit_512.sh, then run it
...
LABELS_FILE="${NULL_DIR}/null_labels_n512.npy"
SOURCE_CSV="/workspace/outputs/real_data_analysis_canonical/clusters_512/consolidated_metrics_n512.csv"

echo "============================================================"
echo "NULL CLUSTER BASELINE — STAGE 1 (512 clusters)"
echo "============================================================"
...
# ============================================================
echo ""
echo "Step 2: Running AANet training on null clusters (512)..."
...
echo ""
echo "============================================================"
echo "Stage 1 complete for null 512 clusters"
echo "============================================================"
echo ""
echo "Outputs: ${NULL_DIR}/clusters_512/"
echo "  consolidated_metrics_n512.csv"
echo "  aanet_cluster_*_k*.pt"
echo ""
echo "Next: review elbow plots, then run run_null_refit_512.sh"
echo "============================================================"
