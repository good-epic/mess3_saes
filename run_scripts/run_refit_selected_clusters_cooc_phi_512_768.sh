...
python -u real_data_tests/refit_selected_clusters.py \
    --skip_training \
    --stage1_models_dir "/workspace/outputs/real_data_cooc/phi_512" \
    --vertex_skip_docs 1_200_000 \
    --n_clusters_list "512,768" \
    --csv_dir "/workspace/outputs/real_data_cooc/phi_512" \
    --save_dir "/workspace/outputs/selected_clusters_cooc_phi_512_768" \
    ...
    --manual_cluster_ids "512:202,242,299,306,504;768:210,725,531,151,603,749" \
    --manual_k "512:202=3,242=3,299=5,306=3,504=4;768:210=6,725=3,531=3,151=4,603=5,749=7"
