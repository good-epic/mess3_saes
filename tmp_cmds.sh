...
PYTHONPATH=. python -u interpretation/prepare_vertex_samples.py --manifest outputs/selected_null_clusters/manifest.json --output_dir outputs/interpretations/prepared_samples_null --max_samples_per_vertex 200 --min_samples_per_vertex 1
